...
export const dishes = {
  ...
  ar: [
    ...
    { id: 9,  name: 'طبق شاورما',        cat: 'أطباق رئيسية',   catEn: 'Main',     desc: 'دجاج أو لحم متبّل، صلصة ثوم، مخللات، خبز طازج',               price: '٦٨ ج', img: 'https://images.unsplash.com/photo-1561050672-56c1b8e3b14f?w=500&q=80', tag: 'الأكثر طلبًا'  },
